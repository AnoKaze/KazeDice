 ...
 * @since 2023/2/27
 */
public class RollPunishCommand implements UserCommandExecutor {
    @Override
    public void onCommand(User user, Object[] arguments, Message message) {
        ...
        Integer punish = (Integer) arguments[0];
        ...
        Assay assay = DiceUtil.punishAssay(attributeName, attributeValue, punish);
